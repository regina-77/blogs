   ...
   <body>
      ...
      <div class="header_section">
         <div class="container-fluid header_main">
            <nav class="navbar navbar-expand-lg navbar-light bg-light">
               <a class="logo" href="index.html"><img src="{{asset('front/images/logo.png')}}"></a>
                  ...
                  <div class="carousel-inner">
                     <div class="carousel-item active">
                        <div class="image_main">
                           <div class="container">
                              <img src="{{asset('front/images/img-1.png')}}" class="image_1">
         ...
         <div class="container">
            <div class="row">
               <div class="col-lg-8 col-sm-12">
                  <div class="about_img"><img src="{{asset('front/images/about-img.png')}}"></div>
                  <div class="like_icon"><img src="{{asset('front/images/like-icon.png')}}"></div>
               ...
               <div class="col-lg-4 col-sm-12">
                  <div class="image_5"><img src="{{asset('front/images/img-5.png')}}"></div>
      ...
      <div class="about_section layout_padding">
         <div class="container">
            <div class="row">
               <div class="col-lg-8 col-sm-12">
                  <div class="about_img"><img src="{{asset('front/images/img-8.png')}}"></div>
                  <div class="like_icon"><img src="{{asset('front/images/like-icon.png')}}"></div>
                  <p class="post_text">Post By : 09/06/2019</p>
               ...
               <div class="col-lg-4 col-sm-12">
                  <div class="about_main">
                     ...
                     <div class="follow_icon">
                        <ul>
                           <li><a href="#"><img src="{{asset('front/images/fb-icon-1.png')}}"></a></li>
                           <li><a href="#"><img src="{{asset('front/images/twitter-icon-1.png')}}"></a></li>
                           <li><a href="#"><img src="{{asset('front/images/linkedin-icon-1.png')}}"></a></li>
                           <li><a href="#"><img src="{{asset('front/images/instagram-icon-1.png')}}"></a></li>
                        </ul>
                     </div>
                  </div>
               </div>
      ...
      <div class="about_section layout_padding">
         <div class="container">
            <div class="row">
               <div class="col-lg-8 col-sm-12">
                  <div class="about_img"><img src="{{asset('front/images/img-9.png')}}"></div>
                  <div class="like_icon"><img src="{{asset('front/images/like-icon.png')}}"></div>
                  <p class="post_text">Post By : 09/06/2019</p>
      ...
      <div class="about_section layout_padding">
         <div class="container">
            <div class="row">
               <div class="col-lg-8 col-sm-12">
                  <div class="about_img"><img src="{{asset('front/images/img-10.png')}}"></div>
                  <div class="like_icon"><img src="{{asset('front/images/like-icon.png')}}"></div>
                  <p class="post_text">Post By : 09/06/2019</p>
                  ...
                  <div class="newsletter_main">
                     ...
                     <div class="recent_box">
                        <div class="recent_left">
                           <div class="image_6"><img src="{{asset('front/images/img-6.png')}}"></div>
                        </div>
                     ...
                     <div class="recent_box">
                        <div class="recent_left">
                           <div class="image_6"><img src="{{asset('front/images/img-7.png')}}"></div>
                        </div>
                        <div class="recent_right">
                           <h3 class="consectetur_text">Consectetur adipiscing</h3>
                           <p class="dolor_text">ipsum dolor sit amet, consectetur adipiscing </p>
      ...
      <div class="footer_section layout_padding">
         <div class="container">
            ...
            <div class="contact_menu">
               <ul>
                  <li><a href="#"><img src="{{asset('front/images/call-icon.png')}}"></a></li>
                  <li><a href="#">Call : +01 1234567890</a></li>
                  <li><a href="blog.html"><img src="{{asset('front/images/mail-icon.png')}}"></a></li>
